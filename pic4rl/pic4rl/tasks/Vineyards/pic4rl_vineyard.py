...
class Pic4rlVineyards(Pic4rlEnvironmentCamera):
    def __init__(
        self,
    ):
        super().__init__()
...
def main(args=None):
    ...
    pic4rl_camera_vineyard = Pic4rlVineyards()
    executor = SingleThreadedExecutor()
    executor.add_node(pic4rl_camera_vineyard)
    executor.spin()
    executor.shutdown()
    pic4rl_camera_vineyard.destroy_node()
    rclpy.shutdown()
